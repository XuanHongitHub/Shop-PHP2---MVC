    ...
    <div class="row align-items-center">
        ...
        <div class="col-lg-6 col-md-6">
            <div class="about_content">
                <h1>About Us</h1>
                <p>PHP2 is a well-known fashion store in Danang City, specializing in providing a wide range of
                    fashion and accessory products for both men and women. With a mission to create style and
                    confidence for customers, PHP2 continually strives to bring quality products and the latest
                    trends from the international fashion market.</p>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="col-lg-6 col-md-6">
            <div class="progressbar_inner">
                ...
                <div class="progress_skill">
                    <div class="progress">
                        <div class="progress-bar about_prog wow fadeInLeft" data-wow-duration="0.8s"
                            data-wow-delay=".3s" role="progressbar" style="width: 60%" aria-valuenow="25"
                ...
                <div class="progress_skill">
                    <div class="progress">
                        <div class="progress-bar about_prog wow fadeInLeft" data-wow-duration="0.8s"
                            data-wow-delay=".5s" role="progressbar" style="width: 90%" aria-valuenow="25"
                            aria-valuemin="0" aria-valuemax="100">
                ...
                <div class="progress_skill">
                    <div class="progress">
                        <div class="progress-bar about_prog wow fadeInLeft" data-wow-duration="0.8s"
                            data-wow-delay=".7s" role="progressbar" style="width: 70%" aria-valuenow="25"
                            aria-valuemin="0" aria-valuemax="100">
