...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href="index.php?controller=home&action=index"><b>Pos Coron</b></a>
        </div>
        <!-- /.login-logo -->
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <p class="mb-1">
                    <a href="index.php?controller=auth&action=forgot">I forgot my password</a>
                </p>
                <p class="mb-0">
    ...
    <!-- jQuery -->
    <script src="../mvc/admin/assets/plugins/jquery/jquery.min.js"></script>
    <!-- Bootstrap 4 -->
    <script src="../mvc/admin/assets/plugins/bootstrap/js/bootstrap.bundle.min.js"></script>
    <!-- AdminLTE App -->
    <script src="../mvc/admin/assets/dist/js/adminlte.min.js"></script>
</body>
