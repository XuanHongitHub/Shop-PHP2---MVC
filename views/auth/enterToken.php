    ...
    <div class="login-box">
        ...
        <div class="card">
            <div class="card-body login-card-body">
                <p class="login-box-msg">Enter the token you received to create a new password.</p>
                <form action="index.php?controller=auth&action=enterToken" method="post">
                    <input type="hidden" name="email"
                        value="<?php echo isset($_GET['email']) ? htmlspecialchars($_GET['email']) : ''; ?>">
                    <?php var_dump($email); ?>
                    <div class="input-group mb-3">
                        <input type="text" id="token" name="token" class="form-control" placeholder="Enter the token">
